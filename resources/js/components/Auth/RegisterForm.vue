<template>
    <form @submit.prevent="submit"
        ...
        <button type="submit" :disabled="loading"
                class="w-full flex items-center justify-center space-x-2 bg-green-600 hover:bg-green-700 text-white py-2 rounded-md disabled:opacity-50">
        ...
        <p class="text-center text-gray-600 text-sm">
            ...
            <button type="button" @click="$emit('switch')"
                    class="text-green-600 hover:text-green-800 underline ml-1">Sign In</button>
        </p>
...
export default {
    data() {
        return {
            ...
            errors: {}, serverError: '', loading: false
        }
    },
    methods: {
        async submit() {
